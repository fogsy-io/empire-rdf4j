...
@RdfsClass("http://test.de/Test")
@Entity
public class TestClass  extends NamedStreamPipesEntity {

  private static final long serialVersionUID = -5732549347563182863L;

  private static final String prefix = "urn:fzi.de:eventstream:";

  @RdfProperty("http://test.de/hasEventProperty")
  protected EventProperty eventProperty;

  @OneToMany(fetch = FetchType.EAGER,
          cascade = {CascadeType.PERSIST, CascadeType.MERGE})
  @RdfProperty("http://test.de/hasEventStream")
  protected List<URI> testList;

  public TestClass() {
    super();
  }

  public TestClass(String uri) {
    super(uri);
  }
  public List<URI> getTestList() {
    return testList;
  }

  public void setTestList(List<URI> testList) {
