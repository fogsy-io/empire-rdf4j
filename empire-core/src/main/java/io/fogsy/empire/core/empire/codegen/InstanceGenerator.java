...
public final class InstanceGenerator {
	...
	public synchronized static <T> Class<T> generateInstanceClass(Class<T> theInterface) throws Exception {
		...
		aClass.addField(aAllTriplesField, CtField.Initializer.byExpr("io.fogsy.empire.cp.openrdf.utils.model.Models2.newModel();"));
		
		CtField aInstanceTriplesField = new CtField(aPool.get(Model.class.getName()), "mInstanceTriples", aClass);
		aClass.addField(aInstanceTriplesField, CtField.Initializer.byExpr("io.fogsy.empire.cp.openrdf.utils.model.Models2.newModel();"));
